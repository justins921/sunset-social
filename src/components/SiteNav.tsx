      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        >
          ...
          <span className="text-sm sm:text-base">
            Sunset Social <span className="text-accent">Golf</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-line text-ink2 lg:hidden"
