...
export const SCHEDULE: ScheduleWeek[] = [
  ...
  { date: "2026-05-14", label: "May 14", matchups: ["4 v 9", "10 v 3", "8 v 5", "6 v 7"] },
  { date: "2026-05-21", label: "May 21", matchups: ["1 v 2", "4 v 2", "8 v 7"] },
  {
    date: "2026-05-28",
    label: "May 28",
    note: "Brats & Burgers Night · FUN NIGHT · Red, White & Blue",
    matchups: ["10 v 5", "9 v 6", "1 v 3"],
  },
  { date: "2026-06-04", label: "Jun 4", matchups: ["10 v 7", "9 v 8", "5 v 3", "6 v 2", "1 v 4"] },
  { date: "2026-06-11", label: "Jun 11", matchups: ["7 v 3", "5 v 7", "8 v 2", "6 v 1"] },
  { date: "2026-06-18", label: "Jun 18", matchups: ["4 v 6", "9 v 3", "10 v 2"] },
  {
    date: "2026-06-25",
    label: "Jun 25",
    note: "Perch Fry & Potato Salad Night · Position Round",
    matchups: ["6 v 2", "5 v 1", "8 v 4", "9 v 10"],
  },
  { date: "2026-07-02", label: "Jul 2", matchups: ["8 v 6", "2 v 7", "5 v 9", "10 v 4", "3 v 2"] },
  { date: "2026-07-09", label: "Jul 9", matchups: ["7 v 1", "4 v 5", "5 v 2", "3 v 4"] },
  { date: "2026-07-16", label: "Jul 16", matchups: ["10 v 6", "9 v 7", "2 v 9", "3 v 6", "8 v 1"] },
  { date: "2026-07-23", label: "Jul 23", matchups: ["2 v 7", "3 v 8", "1 v 10", "6 v 5", "10 v 8", "9 v 1"] },
  {
    date: "2026-07-30",
    label: "Jul 30",
    note: "Chicken Tender & Fries · FUN NIGHT · 3 Clubs",
    matchups: ["4 v 7 (Rain Makeup)", "2 v 1", "7 v 6", "5 v 10", "6 v 9"],
  },
  { date: "2026-08-06", label: "Aug 6", matchups: ["5 v 8 (Rain Makeup)", "2 v 4 (Rain Makeup)"] },
  { date: "2026-08-13", label: "Aug 13", matchups: ["3 v 10", "9 v 4"] },
  { date: "2026-08-20", label: "Aug 20", note: "Position Round", matchups: ["3 v 1", "7 v 8"] },
  {
    date: "2026-08-27",
    label: "Aug 27",
